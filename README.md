# F1 Prediction model(isn't finished yet)
...
- Constructor data
- Qualifying results
- Lap times an pit syop info

**Data size:** 26 759 race results across multiple seasons

## Files
- 'dataset.py' -Data cleaning
- 'modelof1.csv' - Cleaned dataset
- 'modelo.py' - Model training
